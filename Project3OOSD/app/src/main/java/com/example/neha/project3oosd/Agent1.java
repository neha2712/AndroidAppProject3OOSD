...
public class Agent1 extends AppCompatActivity implements ListView.OnItemClickListener
{
    ...
    private void showAgents(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                Agent1.this, list, R.layout.agent1_custom_column,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Agent1.this,"Fetching Data","Wait...",false,false);
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendGetRequest(Config.URL_GET_ALL1);
                return s;
            }
        }
